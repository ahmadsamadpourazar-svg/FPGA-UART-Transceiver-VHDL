-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\MATLAB_TO_VHDL3_SIMULINK\nfp_sub_comp.vhd
...
-- 
-- Module: nfp_sub_comp
-- Source Path: MATLAB_TO_VHDL3_SIMULINK/Subsystem1/nfp_sub_comp
-- Hierarchy Level: 1
-- 
...
ARCHITECTURE rtl OF nfp_sub_comp IS
  ...
  SIGNAL Delay18_PS_7_10_reg              : std_logic_vector(0 TO 7);  -- ufix1 [8]
  SIGNAL Delay18_PS_7_10_reg_next         : std_logic_vector(0 TO 7);  -- ufix1 [8]
  ...
  SIGNAL Delay2_PS_7_reg_next             : vector_of_unsigned11(0 TO 3);  -- ufix11 [4]
  ...
  SIGNAL Delay1_PS_5_reg_next             : vector_of_signed57(0 TO 1);  -- sfix57 [2]
  ...
  SIGNAL Delay6_PS_2_reg                  : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay6_PS_2_reg_next             : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay9_PS_8_reg                  : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay9_PS_8_reg_next             : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay7_PS_8_reg_next             : vector_of_unsigned56(0 TO 1);  -- ufix56 [2]
  ...
  SIGNAL Delay11_PS_8_reg                 : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay11_PS_8_reg_next            : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay10_PS_8_reg                 : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay10_PS_8_reg_next            : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay14_PS_7_10_reg              : std_logic_vector(0 TO 7);  -- ufix1 [8]
  SIGNAL Delay14_PS_7_10_reg_next         : std_logic_vector(0 TO 7);  -- ufix1 [8]
  SIGNAL Delay14_PS_7_10_out1             : std_logic;  -- ufix1
  SIGNAL alphaaSign_1_bSign_1_out1        : std_logic;  -- ufix1
  SIGNAL Delay13_PS_7_10_reg              : std_logic_vector(0 TO 7);  -- ufix1 [8]
  SIGNAL Delay13_PS_7_10_reg_next         : std_logic_vector(0 TO 7);  -- ufix1 [8]
  ...
  SIGNAL Delay15_PS_7_10_reg_next         : vector_of_unsigned11(0 TO 7);  -- ufix11 [8]
  ...
  SIGNAL Delay17_PS_7_10_reg_next         : vector_of_unsigned52(0 TO 6);  -- ufix52 [7]
...
BEGIN
  ...
  Relational_Operator1_relop1 <= '1' WHEN Delay1_PS_1_out1 = Delay4_PS_1_out1 ELSE
      '0';
  ...
  Relational_Operator_relop1 <= '1' WHEN Delay1_PS_1_out1 > Delay4_PS_1_out1 ELSE
      '0';

  
  bitconcat_aExponent_aMantissa_relop1 <= '1' WHEN Delay2_PS_1_out1 >= Delay5_PS_1_out1 ELSE
      '0';
  ...
  BEGIN
    IF reset = '1' THEN
      Delay18_PS_7_10_reg(0) <= '0';
      Delay18_PS_7_10_reg(1) <= '0';
      Delay18_PS_7_10_reg(2) <= '0';
      Delay18_PS_7_10_reg(3) <= '0';
      Delay18_PS_7_10_reg(4) <= '0';
      Delay18_PS_7_10_reg(5) <= '0';
      Delay18_PS_7_10_reg(6) <= '0';
      Delay18_PS_7_10_reg(7) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay18_PS_7_10_reg_next(0) <= aExponent_cfType_Exponent_I_out1;
  Delay18_PS_7_10_reg_next(1) <= Delay18_PS_7_10_reg(0);
  Delay18_PS_7_10_reg_next(2) <= Delay18_PS_7_10_reg(1);
  Delay18_PS_7_10_reg_next(3) <= Delay18_PS_7_10_reg(2);
  Delay18_PS_7_10_reg_next(4) <= Delay18_PS_7_10_reg(3);
  Delay18_PS_7_10_reg_next(5) <= Delay18_PS_7_10_reg(4);
  Delay18_PS_7_10_reg_next(6) <= Delay18_PS_7_10_reg(5);
  Delay18_PS_7_10_reg_next(7) <= Delay18_PS_7_10_reg(6);
  ...
  BEGIN
    IF reset = '1' THEN
      Delay2_PS_7_reg(0) <= to_unsigned(16#000#, 11);
      Delay2_PS_7_reg(1) <= to_unsigned(16#000#, 11);
      Delay2_PS_7_reg(2) <= to_unsigned(16#000#, 11);
      Delay2_PS_7_reg(3) <= to_unsigned(16#000#, 11);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay2_PS_7_reg_next(0) <= Delay1_PS_3_out1;
  Delay2_PS_7_reg_next(1) <= Delay2_PS_7_reg(0);
  Delay2_PS_7_reg_next(2) <= Delay2_PS_7_reg(1);
  Delay2_PS_7_reg_next(3) <= Delay2_PS_7_reg(2);
  ...
  BEGIN
    IF reset = '1' THEN
      Delay1_PS_5_reg(0) <= to_signed(0, 57);
      Delay1_PS_5_reg(1) <= to_signed(0, 57);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay1_PS_5_reg_next(0) <= Delay2_PS_3_out1;
  Delay1_PS_5_reg_next(1) <= Delay1_PS_5_reg(0);
  ...
  Logical_Operator_out1_1 <=  NOT Delay3_PS_1_out1;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay3_PS_2_out1 <= Logical_Operator_out1_1;
      END IF;
    END IF;
  ...
  Delay6_PS_2_reg_next(0) <= aSign;
  Delay6_PS_2_reg_next(1) <= Delay6_PS_2_reg(0);
  ...
  alphamant_b_ext_in0 <=  - (resize(Delay2_PS_3_out1_1, 58));
  ...
  Delay9_PS_8_reg_next(0) <= BitSlice_out1;
  Delay9_PS_8_reg_next(1) <= Delay9_PS_8_reg(0);

  Logical_Operator_out1_2 <= exp_norm_cfType_Exponent_In_out1 AND Delay9_PS_8_out1;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay13_PS_9_out1 <= Logical_Operator_out1_2;
      END IF;
    END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      Delay7_PS_8_reg(0) <= to_unsigned(0, 56);
      Delay7_PS_8_reg(1) <= to_unsigned(0, 56);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay7_PS_8_reg_next(0) <= Delay_PS_6_out1;
  Delay7_PS_8_reg_next(1) <= Delay7_PS_8_reg(0);
  ...
  Logical_Operator_out1_3 <= Bit_Slice3_out1 OR Bit_Slice2_out1_2;
  ...
  Logical_Operator_out1_4 <= Logical_Operator12_out1_3 OR Logical_Operator12_out1_4;
  ...
  Switch1_out1_1 <= Switch_out1_1 WHEN Logical_Operator_out1_4 = '0' ELSE
      Switch2_out1_1;
  ...
  shift_length_exp_a_cor_relop1 <= '1' WHEN Delay_PS_7_out1 >= Bit_Slice_out1_2 ELSE
      '0';
  ...
  Logical_Operator_out1_5 <=  NOT Bit_Slice1_out1_3;
  ...
  Logical_Operator_out1_6 <= Logical_Operator_out1_5 AND Logical_Operator11_out1;

  Bit_Slice1_out1_4 <= Delay7_PS_4_out1(2);

  Logical_Operator2_out1_3 <= Logical_Operator_out1_6 AND Bit_Slice1_out1_4;
  ...
  Logical_Operator_out1_7 <=  NOT Bit_Slice2_out1_3;

  Logical_Operator1_out1_4 <= Logical_Operator2_out1_4 AND Logical_Operator_out1_7;

  
  Switch_out1_2 <= Logical_Operator_out1_6 WHEN Logical_Operator1_out1_4 = '0' ELSE
  ...
  BEGIN
    IF reset = '1' THEN
      Delay11_PS_8_reg(0) <= '0';
      Delay11_PS_8_reg(1) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay11_PS_8_reg_next(0) <= Delay6_PS_6_out1;
  Delay11_PS_8_reg_next(1) <= Delay11_PS_8_reg(0);
  ...
  BEGIN
    IF reset = '1' THEN
      Delay10_PS_8_reg(0) <= '0';
      Delay10_PS_8_reg(1) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay10_PS_8_reg_next(0) <= sticky_bitget_Sum_1_out1;
  Delay10_PS_8_reg_next(1) <= Delay10_PS_8_reg(0);
  ...
  Switch_out1_3 <= alphaExponent_0_Mantissa_out1 WHEN Delay18_PS_7_10_out1 = '0' ELSE
      Constant_out1_3;

  Delay14_PS_7_10_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay14_PS_7_10_reg(0) <= '0';
      Delay14_PS_7_10_reg(1) <= '0';
      Delay14_PS_7_10_reg(2) <= '0';
      Delay14_PS_7_10_reg(3) <= '0';
      Delay14_PS_7_10_reg(4) <= '0';
      Delay14_PS_7_10_reg(5) <= '0';
      Delay14_PS_7_10_reg(6) <= '0';
      Delay14_PS_7_10_reg(7) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay14_PS_7_10_reg_next(0) <= if_bitconcat_aExponent_aMantiss_2_out1;
  Delay14_PS_7_10_reg_next(1) <= Delay14_PS_7_10_reg(0);
  Delay14_PS_7_10_reg_next(2) <= Delay14_PS_7_10_reg(1);
  Delay14_PS_7_10_reg_next(3) <= Delay14_PS_7_10_reg(2);
  Delay14_PS_7_10_reg_next(4) <= Delay14_PS_7_10_reg(3);
  Delay14_PS_7_10_reg_next(5) <= Delay14_PS_7_10_reg(4);
  Delay14_PS_7_10_reg_next(6) <= Delay14_PS_7_10_reg(5);
  Delay14_PS_7_10_reg_next(7) <= Delay14_PS_7_10_reg(6);
  ...
  BEGIN
    IF reset = '1' THEN
      Delay13_PS_7_10_reg(0) <= '0';
      Delay13_PS_7_10_reg(1) <= '0';
      Delay13_PS_7_10_reg(2) <= '0';
      Delay13_PS_7_10_reg(3) <= '0';
      Delay13_PS_7_10_reg(4) <= '0';
      Delay13_PS_7_10_reg(5) <= '0';
      Delay13_PS_7_10_reg(6) <= '0';
      Delay13_PS_7_10_reg(7) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay13_PS_7_10_reg_next(0) <= alphaaSign_1_bSign_1_out1;
  Delay13_PS_7_10_reg_next(1) <= Delay13_PS_7_10_reg(0);
  Delay13_PS_7_10_reg_next(2) <= Delay13_PS_7_10_reg(1);
  Delay13_PS_7_10_reg_next(3) <= Delay13_PS_7_10_reg(2);
  Delay13_PS_7_10_reg_next(4) <= Delay13_PS_7_10_reg(3);
  Delay13_PS_7_10_reg_next(5) <= Delay13_PS_7_10_reg(4);
  Delay13_PS_7_10_reg_next(6) <= Delay13_PS_7_10_reg(5);
  Delay13_PS_7_10_reg_next(7) <= Delay13_PS_7_10_reg(6);
  ...
  BEGIN
    IF reset = '1' THEN
      Delay15_PS_7_10_reg(0) <= to_unsigned(16#000#, 11);
      Delay15_PS_7_10_reg(1) <= to_unsigned(16#000#, 11);
      Delay15_PS_7_10_reg(2) <= to_unsigned(16#000#, 11);
      Delay15_PS_7_10_reg(3) <= to_unsigned(16#000#, 11);
      Delay15_PS_7_10_reg(4) <= to_unsigned(16#000#, 11);
      Delay15_PS_7_10_reg(5) <= to_unsigned(16#000#, 11);
      Delay15_PS_7_10_reg(6) <= to_unsigned(16#000#, 11);
      Delay15_PS_7_10_reg(7) <= to_unsigned(16#000#, 11);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay15_PS_7_10_reg_next(0) <= if_bitconcat_aExponent_aMantiss_out1;
  Delay15_PS_7_10_reg_next(1) <= Delay15_PS_7_10_reg(0);
  Delay15_PS_7_10_reg_next(2) <= Delay15_PS_7_10_reg(1);
  Delay15_PS_7_10_reg_next(3) <= Delay15_PS_7_10_reg(2);
  Delay15_PS_7_10_reg_next(4) <= Delay15_PS_7_10_reg(3);
  Delay15_PS_7_10_reg_next(5) <= Delay15_PS_7_10_reg(4);
  Delay15_PS_7_10_reg_next(6) <= Delay15_PS_7_10_reg(5);
  Delay15_PS_7_10_reg_next(7) <= Delay15_PS_7_10_reg(6);
  ...
  BEGIN
    IF reset = '1' THEN
      Delay17_PS_7_10_reg(0) <= to_unsigned(0, 52);
      Delay17_PS_7_10_reg(1) <= to_unsigned(0, 52);
      Delay17_PS_7_10_reg(2) <= to_unsigned(0, 52);
      Delay17_PS_7_10_reg(3) <= to_unsigned(0, 52);
      Delay17_PS_7_10_reg(4) <= to_unsigned(0, 52);
      Delay17_PS_7_10_reg(5) <= to_unsigned(0, 52);
      Delay17_PS_7_10_reg(6) <= to_unsigned(0, 52);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay17_PS_7_10_reg_next(0) <= Delay2_PS_3_out1_2;
  Delay17_PS_7_10_reg_next(1) <= Delay17_PS_7_10_reg(0);
  Delay17_PS_7_10_reg_next(2) <= Delay17_PS_7_10_reg(1);
  Delay17_PS_7_10_reg_next(3) <= Delay17_PS_7_10_reg(2);
  Delay17_PS_7_10_reg_next(4) <= Delay17_PS_7_10_reg(3);
  Delay17_PS_7_10_reg_next(5) <= Delay17_PS_7_10_reg(4);
  Delay17_PS_7_10_reg_next(6) <= Delay17_PS_7_10_reg(5);
