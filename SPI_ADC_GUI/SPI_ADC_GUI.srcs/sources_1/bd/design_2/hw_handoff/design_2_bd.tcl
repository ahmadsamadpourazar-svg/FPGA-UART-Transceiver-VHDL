...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set cfgclk_0 [ create_bd_port -dir O cfgclk_0 ]
  set cfgmclk_0 [ create_bd_port -dir O cfgmclk_0 ]
  set eos_0 [ create_bd_port -dir O eos_0 ]
  set interrupt_0 [ create_bd_port -dir O -type intr interrupt_0 ]
  set io0_i_0 [ create_bd_port -dir I io0_i_0 ]
  set io0_o_0 [ create_bd_port -dir O io0_o_0 ]
  set io0_t_0 [ create_bd_port -dir O io0_t_0 ]
  set io1_i_0 [ create_bd_port -dir I io1_i_0 ]
  set io1_o_0 [ create_bd_port -dir O io1_o_0 ]
  set io1_t_0 [ create_bd_port -dir O io1_t_0 ]
  set ip2intc_irpt_0 [ create_bd_port -dir O -type intr ip2intc_irpt_0 ]
  set preq_0 [ create_bd_port -dir O preq_0 ]
  ...
  set rsta_busy_1 [ create_bd_port -dir O rsta_busy_1 ]
  set rx_0 [ create_bd_port -dir I rx_0 ]
  set ss_i_0 [ create_bd_port -dir I -from 0 -to 0 ss_i_0 ]
  set ss_o_0 [ create_bd_port -dir O -from 0 -to 0 ss_o_0 ]
  set ss_t_0 [ create_bd_port -dir O ss_t_0 ]
  ...
  # Create instance: axi_bram_ctrl_0_bram_0, and set properties
  set axi_bram_ctrl_0_bram_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 axi_bram_ctrl_0_bram_0 ]
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTB [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTB] [get_bd_intf_pins axi_bram_ctrl_0_bram_0/BRAM_PORTA]
  ...
  # Create port connections
  connect_bd_net -net axi_quad_spi_0_cfgclk [get_bd_ports cfgclk_0] [get_bd_pins axi_quad_spi_0/cfgclk]
  connect_bd_net -net axi_quad_spi_0_cfgmclk [get_bd_ports cfgmclk_0] [get_bd_pins axi_quad_spi_0/cfgmclk]
  connect_bd_net -net axi_quad_spi_0_eos [get_bd_ports eos_0] [get_bd_pins axi_quad_spi_0/eos]
  connect_bd_net -net axi_quad_spi_0_io0_o [get_bd_ports io0_o_0] [get_bd_pins axi_quad_spi_0/io0_o]
  connect_bd_net -net axi_quad_spi_0_io0_t [get_bd_ports io0_t_0] [get_bd_pins axi_quad_spi_0/io0_t]
  connect_bd_net -net axi_quad_spi_0_io1_o [get_bd_ports io1_o_0] [get_bd_pins axi_quad_spi_0/io1_o]
  connect_bd_net -net axi_quad_spi_0_io1_t [get_bd_ports io1_t_0] [get_bd_pins axi_quad_spi_0/io1_t]
  connect_bd_net -net axi_quad_spi_0_ip2intc_irpt [get_bd_ports ip2intc_irpt_0] [get_bd_pins axi_quad_spi_0/ip2intc_irpt]
  connect_bd_net -net axi_quad_spi_0_preq [get_bd_ports preq_0] [get_bd_pins axi_quad_spi_0/preq]
  connect_bd_net -net axi_quad_spi_0_ss_o [get_bd_ports ss_o_0] [get_bd_pins axi_quad_spi_0/ss_o]
  connect_bd_net -net axi_quad_spi_0_ss_t [get_bd_ports ss_t_0] [get_bd_pins axi_quad_spi_0/ss_t]
  ...
  connect_bd_net -net io0_i_0_1 [get_bd_ports io0_i_0] [get_bd_pins axi_quad_spi_0/io0_i]
  connect_bd_net -net io1_i_0_1 [get_bd_ports io1_i_0] [get_bd_pins axi_quad_spi_0/io1_i]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  connect_bd_net -net rx_0_1 [get_bd_ports rx_0] [get_bd_pins axi_uartlite_0/rx]
  connect_bd_net -net ss_i_0_1 [get_bd_ports ss_i_0] [get_bd_pins axi_quad_spi_0/ss_i]
